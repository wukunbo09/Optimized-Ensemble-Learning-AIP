...
def process_file(file_path):
    ...
    model = Sequential()
    model.add(Conv1D(64, kernel_size=3, activation='relu', input_shape=(X_train_selected.shape[1], 1)))
    ...
    model.fit(X_train_cnn, y_train_res, epochs=20, batch_size=32, verbose=0, validation_split=0.3)
